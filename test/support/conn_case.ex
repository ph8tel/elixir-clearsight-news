defmodule ClearsightNewsWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use ClearsightNewsWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use ClearsightNewsWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import ClearsightNewsWeb.ConnCase
    end
  end
